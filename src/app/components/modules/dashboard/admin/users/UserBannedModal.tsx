  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <span className={`cursor-pointer ${userBan === true ? 'bg-red-700 text-white/90' : ''} p-2 rounded-md border border-foreground/50 w-full text-center`}>{userBan === true ? 'بن شده' : 'بن کردن'}</span>
      </AlertDialogTrigger>
      <AlertDialogContent>
        <AlertDialogHeader>
