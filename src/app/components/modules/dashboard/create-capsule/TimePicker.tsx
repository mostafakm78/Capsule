    ...
    <Calendar
      ...
      onSelect={(selectedDate) => {
        if (selectedDate) {
          ...
          dispatch(setDateCapsule(selectedDate.toISOString())); // تبدیل به string اگر slice انتظار string داره
        }
      }}
...
function CalendarDayButton({ className, day, modifiers, ...props }: React.ComponentProps<typeof DayButton>) {
  ...
  return (
    <Button
      ...
      disabled={modifiers.disabled} // اضافه شد
      className={cn(
