...
export default function LastRelatedCapsules({ singleCapsule }: Props) {
  ...
  return (
    <>
      <div className="flex flex-col mt-12 lg:px-0 px-2 lg:flex-row lg:items-center justify-center w-full" aria-label="Related Capsules Section">
      ...
      <div className="relative overflow-visible w-full lg:px-4 mx-auto max-w-[400px] md:max-w-3xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl min-h-[400px]" role="region" aria-label="Related capsules carousel">
