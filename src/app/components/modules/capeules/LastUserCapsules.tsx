  ...
  return (
    <>
      ...
      <div className="relative overflow-visible w-full lg:px-4 mx-auto max-w-[400px] md:max-w-3xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl min-h-[400px]">
        {filterCapsules && filterCapsules.length === 1 && filterCapsules.length > 0 && <div className="flex items-center w-full h-full justify-center text-2xl lg:text-3xl text-foreground/80">کپسول دیگه ای پیدا نشد!</div>}
