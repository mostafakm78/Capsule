...
export default function Register() {
  ...
  return (
    <section className="flex flex-col mb-20 px-10 justify-center lg:mt-44 mt-20 items-center">
      <div className="flex lg:flex-row flex-col gap-10 justify-center items-center">
        <div className="w-full space-y-6">
          <div className="section-one flex items-center">
            ...
            <h4 className="section-one lg:text-4xl text-2xl mx-auto lg:mx-0 font-kalmeh text-foreground">خاطرات امروز، گنجینه فردای تو هستند</h4>
          </div>
          <p className="section-one lg:text-xl text-base text-foreground/70 mx-auto lg:mx-0 w-full lg:w-2/3 lg:mr-14 ">متن، عکس، ویدئو یا صدایی که امروز ثبت می‌کنی، فردا ممکنه باارزش‌ترین چیزی باشه که داری</p>
        </div>
        <div className="w-full flex flex-col items-center justify-center gap-6">
          <h4 className="section-two lg:text-2xl text-xl">همین حالا اولین کپسول خاطره‌ات رو بساز!</h4>
