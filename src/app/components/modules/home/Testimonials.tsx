      ...
      <div className="flex gap-10 justify-center items-center">
        <div className="w-full space-y-6">
          ...
          <div className="flex items-center w-2/3 justify-between text-xl text-foreground/70 mr-14">
            ...
            <svg className="text-foreground/60 transform rotate-0" width="81" height="25" viewBox="0 0 81 25" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <div className="w-full relative after:content-[''] after:absolute after:h-full after:w-full after:bg-foreground/25 after:top-1/2 after:left-1/2 after:-translate-y-1/2 after:-translate-x-1/2 after:blur-2xl">
