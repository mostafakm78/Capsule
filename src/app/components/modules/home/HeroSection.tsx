      ...
      <div className="flex flex-col px-10 items-center py-6 gap-8 rounded-lg w-full">
        <div className="flex items-center justify-center gap-16 w-full">
          <div className="flex flex-col w-1/2 gap-10 justify-center items-center">
            ...
            <ShinyButton className="w-2/3 bg-secondary hover:bg-primary hover:border-primary shadow-lg py-4">
              <Link href="">
                شروع رایگان
              </Link>
            </ShinyButton>
          ...
          <div className="px-10 w-1/2">
            <div className="flex flex-col w-full gap-12 justify-center items-center">
              <div className="relative w-[950px] h-[500px]">
                <svg className="absolute inset-0 w-full h-full" id="character-background-area" viewBox="0 0 550 520" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    opacity="0.5"
