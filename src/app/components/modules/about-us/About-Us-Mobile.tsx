    ...
    <section className="dotted block lg:hidden my-6">
      <div className="bg-background relative px-4 md:px-6 lg:px-10 gap-10 flex flex-col items-center justify-center">
        <div className="flex flex-col items-center gap-6">
          ...
          <svg className="sec-one text-foreground/70 h-[70px]" width="98" height="129" viewBox="0 0 98 129" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <div className="flex flex-col items-center rounded-xl p-4 gap-6">
          <h3 className="text-3xl font-kalmeh self-start text-foreground">مأموریت ما</h3>
        ...
        <div className="flex flex-col items-center rounded-xl p-4 gap-6">
          <h3 className="text-3xl font-kalmeh self-start text-foreground">امنیت و حریم خصوصی</h3>
          <Separator className="w-full bg-foreground/20" />
          <p className="text-justify text-lg text-foreground/80">
            ما باور داریم که خاطرات شما خصوصی و ارزشمند هستند. کپسول با استفاده از استانداردهای بالای امنیتی، از محتوای شما به‌شکل کاملاً رمزگذاری‌شده نگهداری می‌کند. فقط شما تصمیم می‌گیرید چه زمانی و با چه کسی آن‌ها را به اشتراک بگذارید.
          </p>
        </div>
        <div className="flex flex-col items-center rounded-xl p-4 gap-6">
          <h3 className="text-3xl font-kalmeh self-start text-foreground"> برای حال، برای آینده</h3>
          <Separator className="w-full bg-foreground/20" />
        ...
        <div className="flex flex-col items-center rounded-xl p-4 gap-6">
          <h3 className="text-3xl font-kalmeh self-start text-foreground">همراهی با کاربران</h3>
          <Separator className="w-full bg-foreground/20" />
        ...
        <div className="flex flex-col items-center rounded-xl p-4 gap-6">
          <h3 className="text-3xl font-kalmeh self-start text-foreground">چشم‌انداز</h3>
          <Separator className="w-full bg-foreground/20" />
