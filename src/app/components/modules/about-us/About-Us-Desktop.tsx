...
export default function AboutUsDesktop() {
  ...
  return (
    <section className="dotted lg:block hidden my-16">
      <div className="py-10 bg-background relative px-10 gap-56 flex flex-col items-center justify-center">
        <svg className="absolute flex items-center justify-center h-full w-full top-0 left-1/2 -translate-x-1/2 pointer-events-none text-foreground/50 z-[5]" width="3000" height="1440" viewBox="0 0 1440 3000" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ref={pathRef}
        ...
        <div className="flex w-10/12 z-20 items-center justify-center gap-20">
          <div className="box-one flex shadow-lg flex-col items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="text-8xl font-kalmeh text-foreground">داستان آغاز</h3>
        ...
        <div className="flex items-center justify-between w-10/12 gap-6 z-20">
          ...
          <div className="box-two flex flex-col shadow-lg items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="text-5xl font-kalmeh text-foreground">مأموریت ما</h3>
        ...
        <div className="flex items-center justify-between w-10/12 gap-6 z-20">
          <div className="box-three flex flex-col shadow-lg items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="text-5xl font-kalmeh text-foreground">امنیت و حریم خصوصی</h3>
        ...
        <div className="flex items-center justify-between w-10/12 gap-6 z-20">
          <div className="w-1/2 block"></div>
          <div className="box-four flex flex-col shadow-lg items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="text-5xl font-kalmeh text-foreground"> برای حال، برای آینده</h3>
        ...
        <div className="flex items-center justify-between w-10/12 gap-6 z-20">
          <div className="box-five flex flex-col shadow-lg items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="text-5xl font-kalmeh text-foreground">همراهی با کاربران</h3>
        ...
        <div className="flex items-center justify-center w-10/12 gap-6 z-20">
          <div className="box-six flex flex-col shadow-lg items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="text-5xl font-kalmeh text-foreground">چشم‌انداز</h3>
