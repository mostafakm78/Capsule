      ...
      <div className="px-4 md:px-6 lg:px-10 flex flex-col items-center gap-20">
        ...
        <div className='bg-white dark:bg-slate-900 lg:w-10/12 w-full gap-4 p-10 rounded-lg shadow-md shadow-foreground/10 dark:shadow-black/10 flex flex-col'>
            <div className='flex flex-col gap-2 text-foreground/80 font-bold'>
                ...
                <span className='md:text-xl text-base font-light text-foreground/50'>٠٩١٦٩٧٩٩٥٣٣</span>
            </div>
            <div className='flex flex-col gap-2 text-foreground/80 font-bold'>
                ...
                <span className='md:text-xl text-base font-light text-foreground/50'>Mostafamf555@gmail.com</span>
            </div>
        </div>
