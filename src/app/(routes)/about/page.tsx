...
export default function About() {
  ...
  return (
    <div className="dotted my-16">
      <section className="py-10 bg-background relative px-10 lg:gap-56 gap-14 flex flex-col items-center justify-center">
        <svg className="absolute hidden lg:flex items-center justify-center h-full w-full top-0 left-1/2 -translate-x-1/2 pointer-events-none text-foreground/10 z-[5]" width="3000" height="1440" viewBox="0 0 1440 3000" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ref={pathRef}
        ...
        <div className="flex lg:w-10/12 w-full z-20 items-center justify-center gap-20">
          <div className="flex shadow-lg flex-col items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="lg:text-8xl text-5xl font-kalmeh text-foreground">داستان آغاز</h3>
          ...
          <div className="w-1/2 h-[300px] hidden lg:block transform rotate-90">
            <Image src="/images/Logo.png" alt="logo" width={300} height={300} />
          </div>
        </div>

        <div className="flex items-center justify-between lg:w-10/12 w-full gap-6 z-20">
          <div className="w-1/2 hidden lg:block"></div>
          <div className="flex flex-col shadow-lg items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="lg:text-5xl text-3xl font-kalmeh text-foreground">مأموریت ما</h3>
        ...
        <div className="flex items-center justify-between lg:w-10/12 w-full gap-6 z-20">
          <div className="flex flex-col shadow-lg items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="lg:text-5xl text-3xl font-kalmeh text-foreground">امنیت و حریم خصوصی</h3>
        ...
        <div className="flex items-center justify-between lg:w-10/12 w-full gap-6 z-20">
          <div className="w-1/2 hidden lg:block"></div>
          <div className="flex flex-col shadow-lg items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="lg:text-5xl text-3xl font-kalmeh text-foreground"> برای حال، برای آینده</h3>
        ...
        <div className="flex items-center justify-between lg:w-10/12 w-full gap-6 z-20">
          <div className="flex flex-col shadow-lg items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="lg:text-5xl text-3xl font-kalmeh text-foreground">همراهی با کاربران</h3>
        ...
        <div className="flex items-center justify-center lg:w-10/12 w-full gap-6 z-20">
          <div className="flex flex-col shadow-lg items-center bg-accent rounded-xl p-4 gap-6">
            <h3 className="lg:text-5xl text-3xl font-kalmeh text-foreground">چشم‌انداز</h3>
